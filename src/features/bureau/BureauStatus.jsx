  ...
  return (
    <div className="w-full bg-white dark:bg-[#0a0a0a] border-t border-gray-100 dark:border-white/5 py-8 px-6">
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        {/* --- Center: Security Badge (Now more prominent on mobile to push developer info) --- */}
        <div className="hidden md:flex items-center gap-2 opacity-30 hover:opacity-100 transition-opacity">
          <ShieldCheck size={16} />
          <span className="text-[9px] font-bold uppercase tracking-widest text-center">Encrypted Bureau Network <br/> Secure Transmission</span>
        </div>

        {/* --- Right Side: Developer Credits (Relocated to avoid Chatbot overlap) --- */}
        {/* Added 'md:pr-12' to shift it away from the extreme right corner on desktop */}
